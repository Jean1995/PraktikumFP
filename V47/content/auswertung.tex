...
\begin{align*}
  \Theta_{\text{D,exp}} &= \input{build/Theta_deb.tex}.
\end{align*}
Aus dem Zusammenhang \eqref{eqn:4} ergibt dies eine experimentelle Debye-Frequenz von
\begin{align*}
  \omega_{\text{D,exp}} &= \input{build/omega_deb.tex}.
\end{align*}
...
Nach der Formel \eqref{eqn:3} lassen sich außerdem über die transversale und longitudinale Phasengeschwindigkeit \cite{skript} von
\begin{align*}
...
\begin{align*}
  \Theta_{\text{D,Modell}} &= \input{build/Theta_deb_theo.tex},\\
  \omega_{\text{D,Modell}} &= \input{build/omega_deb_theo.tex}
\end{align*}
berechnen.
