...
Die Koinzidenz leitet die Signale nur weiter, wenn beiden Signale der Diskriminatoren innerhalb der Auflösungszeit $\Delta t_\text{K}$ aufeinandertreffen.
...
Des Weiteren lassen die Diskriminatoren nur Impulse durch, welche eine Spannungsschwelle von $U_0$ überschreiten.
...
Selbiges erzeugt beim Zerfall einen Stopimpuls.
...
Das auf dem Rechner vorinstallierte Programm ordnet den Impulsen je nach Höhe einen Kanal zu.\\
...
Dieses Rauschen ist hinreichend gleichmäßig über alle aufgenommenen Zeitintervalle verteilt und ist abhängig von der Suchzeit, der Messzeit und der Gesamtzahl der Startimpulse.
